...
<script language=javaxiaoyuan_ptaic='/greensite/js/My97DatePicker/WdatePicker.js'></script> 
<script language=javxiaoyuan_ptairc='/greensite/js/ajax.js'></script> 
<script language=jaxiaoyuan_ptaisrc='/greensite/js/popup.js'></script> 
