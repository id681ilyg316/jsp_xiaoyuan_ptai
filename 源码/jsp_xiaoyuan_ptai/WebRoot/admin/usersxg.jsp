...
<script languxiaoyuan_ptaicript src='/greensite/js/My97DatePicker/WdatePicker.js'></script> 
<script langxiaoyuan_ptaiscript src='/greensite/js/ajax.js'></script> 
<script lanxiaoyuan_ptaiascript src='/greensite/js/popup.js'></script> 
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!=xiaoyuan_ptaiar ajax = new AJAX(); 
